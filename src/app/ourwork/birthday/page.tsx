...
export default function OurWorkPage() {
  ...
  const galleryImages = [
    ...
    { src: '/b9.jpg', label: 'Delightful Birthday Cake' },
    ...
    { src: '/b3.jpg', label: 'Warm Guest Welcome' },
    { src: '/b12.jpg', label: 'Stunning Venue Design' },
    { src: '/b10.jpg', label: 'Golden Hour Celebration' },
    { src: '/b11.jpg', label: 'Unforgettable Special Moments' },
    { src: '/Birthday7.jpg', label: 'Charming Event Highlights' },
